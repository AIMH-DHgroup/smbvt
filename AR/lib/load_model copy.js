...
if (!chosenModel) {
    ...
    function addAnnotationToList(text, i, point, event_ID) {
        ...
        editButton.addEventListener('click', function (e) {
            ...
            fillForm(title, description, coordinates, position, digobjurl, digobjtitle, entities, point, i, oldPosition, eventID, eventName);
    ...
    function fillForm(title, description, coordinates, position, digobjurl, digobjtitle, entities, point, positionInList ,oldPositionInList, eventID, eventName) {
...
function saveJSONAnnotations() {
    ...
    //const digobjurl = document.getElementById('digobj-url').value; --> not supported yet
    //const digobjtitle = document.getElementById('digobj-title').value; --> not supported yet
