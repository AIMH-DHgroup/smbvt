...
<div id="storymap" class="container-fluid" style="visibility:hidden">
    <div class="row">
        ...
        <div class="col-sm-6 col-md-4 storymap-story">
            ...
            <section data-scene="scene1" id="scene1" data-background="../images/MOVING/sfondo.png" class="sectionSlide">
...
<!-- 					<div class="otherVisual">
					...
					<img src="../images/MOVING/logo.png"  style="width: 20%; position: absolute; left: 0; right: 0; margin: auto;">
...
<!-- <script src="visualizeOrizontalStorymapmisto.js"></script> -->
<script src="visualizeOrizontalStorymapmistoLIBRERIAWKT.js"></script>
